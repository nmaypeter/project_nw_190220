...
if __name__ == "__main__":
    ...
    ### bud_upper_index: (list) the bound budget index for products
    ...
    while not operator.eq(bud_index, bud_upper_index):
        ...
        if bud_pmis <= total_budget:
            ...
            for _ in range(eva_monte_carlo):
                pro_acc += eva.getSeedSetProfit(seed_set_t, copy.deepcopy(wallet_list), copy.deepcopy(personal_prob_list))[0]
